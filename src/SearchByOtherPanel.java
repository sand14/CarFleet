...
public class SearchByOtherPanel extends JPanel implements ActionListener
{
	...
	public SearchByOtherPanel(CarFleetSystem carSys)
	{
		carSystem = carSys;
	...
	private void searchButtonClicked()
	{
		...
		double[] distanceRange = CarFleetSystem.convertToRange((String)distanceCombo.getSelectedItem());

		if (distanceRange[0] >= 0)
		{
			carList = carSystem.search((double)distanceRange[0], (double)distanceRange[1]);
		}
