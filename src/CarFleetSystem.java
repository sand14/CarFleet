...
public class CarFleetSystem extends JFrame implements ActionListener, ComponentListener
{
	
	public static final int CARS_COUNT = 0;
	public static final int MANUFACTURERS_COUNT = 1;
	public static final int AVERAGE_DISTANCE = 2;
	public static final int AVERAGE_AGE = 3;
	public static final int NAME_COUNT = 4;
	public static final int TOTAL_KM = 5;
	...
	private JLabel carCoLabel = new JLabel("Car Fleet Management", JLabel.CENTER);
	...
	public CarFleetSystem(String f)
	{
		super("Car Fleet");
		...
		{
			System.out.println("The data file, 'cars.dat' doesn't exist. Please create an empty file named 'cars.dat'");
			System.exit(0);
		}
	...
	public void removeCar(Car c){
		carCollection.removeCar(c);
	}
	public void checkempty(){
		carCollection.checkmanufacturerempty();
	}
	public void UpdateManufacturer(Car c,String man){
		carCollection.updatemanufacturername(c,man);
	}
	...
	public double getStatistics(int type)
	{
		...
		else if(type == TOTAL_KM)
		{
			result = carCollection.getTotalKm();
		}
	...
	public Car[] search( double minDistance, double maxDistance)
	{
		return carCollection.search(minDistance, maxDistance);
	}

	public Car[] search(String manufacturer){
		return carCollection.search(manufacturer);
	}
